...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            # Data Transformation Artifact path
            ...
            preprocessed_file_object_path = os.path.join(data_transformation_artifact_dir,
            ...
            data_transformation_config = DataTransformationConfig(add_bedroom_per_room = add_bedroom_per_room,
                                preprocessed_file_object_path=preprocessed_file_object_path,
